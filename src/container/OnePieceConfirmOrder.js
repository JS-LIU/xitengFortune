            ...
            <div>
                ...
                <div className="pr">
                    <ul className="onePiece_productInfo">
                        ...
                        <li className="onePiece_productInfo_stage">期数：{this.props.purchaseGame.detail.stage}</li>
                        <li>
                            <span>参与：</span>
                    ...
                    <div className="onePiece_productInfo_realpay tr">
                        <span>实付：</span>
                        <span className="onePiece_productInfo_money">{this.props.purchaseGame.detail.priceOfOneBidInRmb * this.props.purchaseGame.order.purchaseGameCount}</span>
                    </div>
